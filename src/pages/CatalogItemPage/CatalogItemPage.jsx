          ...
          <div className="product-page__info">
            <div className="product-page__header">
              ...
              <div className="product-status">
                ...
                <span className="product-id">Артикул: {item.id}00{item.id}</span>
              </div>
            </div>
            ...
            <div className="product-specs">
              ...
              <ul>
                <li><span>Производитель:</span> <strong>АвтоВАЗ / Тюнинг</strong></li>
                <li><span>Материал:</span> <strong>Высокопрочный сплав</strong></li>
                <li><span>Гарантия:</span> <strong>1 год</strong></li>
              </ul>
            </div>
